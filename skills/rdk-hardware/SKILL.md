---
name: rdk-hardware
description: Hardware facts for the six RDK boards (X3, X5, Ultra, S100, S100P, S600): 40PIN/GPIO, I2C/SPI/UART/PWM, power and LEDs, display, network/IP, CAN, TOPS and RAM. Use whenever a question asks about pin compatibility, IO voltage, credentials, model paths, interfaces, compute, cooling, OS baselines, or system paths. Answer from observed/reference facts because board numbers differ. 触发词:40PIN怎么接、IO电平、默认用户名密码、root/sunrise、模型目录、CAN口、ip link can0、默认IP、192.168.127.10、算力多少TOPS、BPU算力、X3算力、X5算力、内存、散热、供电、电源灯、HDMI、Ubuntu、TROS路径、板型。Routing — boot/error diagnosis → rdk-board-knowledge; peripheral operation → rdk-peripheral-cookbook; model/toolchain/camera → rdk-device; product selection → rdk-ecosystem.
