...
| [hardware-notes.md](references/hardware-notes.md) | Deep dives: TROS env layout, hobot_stereonet calibration summary, Livox lidar networking |
| [calibration-guide.md](references/calibration-guide.md) | **Full calibration deep dive** — stereo checkerboard workflow, IMU config (BMI088/ICM-42688-P), Kalibr cam↔IMU extrinsics (official AMR Docker flow), VIO prerequisites, timestamp sync (FSYNC/PTP), common pitfalls |
